...
uint8_t ActiveCommand[] = { 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x09, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F,
...
void ECODAN::TriggerStatusStateMachine(void) {
  ...
  DEBUG_PRINTLN("Triggering Heat Pump Query to FTC");
  if (!Connected) {
    Connect();
  }
...
void ECODAN::KeepAlive(void) {
  ...
  DEBUG_PRINTLN("FTC Keep Alive Message...");
